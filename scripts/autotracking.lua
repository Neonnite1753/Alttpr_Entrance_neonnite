...
function updateNPCItemFlagsFromMemorySegment(segment)
    ...
    updateSectionChestCountFromByteAndFlag(segment, "@Zora's Area/King Zora", 0x7ef410, 0x02)
...
function updateOverworldEventsFromMemorySegment(segment)
    ...
    updateSectionChestCountFromOverworldIndexAndFlag(segment, "@Zora's Area/Ledge",                       129)    
end
...
function updateRoomsFromMemorySegment(segment)
    ...
    updateSectionChestCountFromRoomSlotList(segment, "@Spectacle Rock Top/Cave", { { 234, 10 } })        
